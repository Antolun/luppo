...
class ShellTestCase(unittest.TestCase):
    ...
    def testCanAccessDirectory(self):
        ...
        # /usr/bin is readable/executable but not writable by non-root; test writable dirs
        assert can_access_directory('/tmp')
        assert not can_access_directory('/nonexistent/path/that/does/not/exist')
