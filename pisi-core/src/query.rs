...
use crate::PisiError;
use pisi_spec::models::PackageDefinition;
use rayon::prelude::*;
use rust_i18n::t;
...
impl QueryManager {
    ...
    pub fn perform_list_available(&self) -> PisiResult<()> {
    ...
    pub fn perform_graph(
        ...
        dot_content.push_str("}\n");
        fs::write(output, dot_content).map_err(PisiError::IoError)?;
        println!("{}", t!("query_graph_saved", path = output));
        println!("{}", t!("query_graph_info", path = output));
        Ok(())
    }

    pub fn perform_search(&self, query: String) -> PisiResult<()> {
    ...
    pub fn perform_search_file(&self, query: &str) -> PisiResult<()> {
    ...
    pub fn perform_list_installed(&self) -> PisiResult<()> {
    ...
    pub fn perform_list_orphaned(&self, installer: &Installer) -> PisiResult<()> {
    ...
    pub fn perform_list_pending(&self) -> PisiResult<()> {
    ...
    pub fn perform_list_sources(&self) -> PisiResult<()> {
        let available = self.db.list_available_packages()?;
        if available.is_empty() {
    ...
    pub fn perform_list_components(&self) -> PisiResult<()> {
    ...
    pub fn get_packages_for_component(&self, comp_name: &str) -> PisiResult<Vec<String>> {
        let available = self.db.list_available_packages()?;
    ...
    pub fn perform_list_newest(&self, limit: usize) -> PisiResult<()> {
    ...
    pub fn perform_list_files(&self, package_name: &str) -> PisiResult<()> {
        if package_name.ends_with(".pisi") && Path::new(package_name).exists() {
    ...
    pub fn perform_info(&self, package_name: &str) -> PisiResult<()> {
    ...
    fn get_reverse_deps(&self, package_name: &str) -> PisiResult<Vec<String>> {
    ...
    pub fn perform_info_hybrid(&self, name: &str) -> PisiResult<()> {
    ...
    pub fn get_package_info(&self, name: &str) -> PisiResult<Option<PackageDefinition>> {
        ...
        Ok(pkg_res.map(|pkg| {
            ...
            PackageDefinition {
                ...
                packager: pisi_spec::models::Packager {
                    name: "Pisi Team".to_string(),
                    email: "admin@pisilinux.org".to_string(),
                },
    ...
    pub fn list_history(&self) -> PisiResult<Vec<pisi_spec::models::HistoryAction>> {
...
mod tests {
    ...
    fn make_db() -> (PisiDatabase, tempfile::TempDir) {
