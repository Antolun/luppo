    ...
    fn default() -> Self {
        ...
        Self {
            build: BuildSettings {
                ...
                compressionlevel: 9,
                enablesandbox: true,
                fallback: "http://source.pisilinux.org".to_string(),
                generatedebug: false,
                jobs: "-j4".to_string(),
                ldflags: "".to_string(),
            ...
            directories: DirectorySettings {
                cache_root_dir: PathBuf::from("/var/cache/pisi"),
                archives_dir: PathBuf::from("/var/cache/pisi/archives"),
                cached_packages_dir: PathBuf::from("/var/cache/pisi/packages"),
                compiled_packages_dir: PathBuf::from("/var/cache/pisi/packages"),
                debug_packages_dir: PathBuf::from("/var/cache/pisi/packages-debug"),
                lib_dir: PathBuf::from("/var/lib/pisi"),
                history_dir: PathBuf::from("/var/lib/pisi/history"),
                index_dir: PathBuf::from("/var/lib/pisi/index"),
                info_dir: PathBuf::from("/var/lib/pisi/info"),
                kde_dir: PathBuf::from("/usr"),
                lock_dir: PathBuf::from("/run/lock/subsys"),
                log_dir: PathBuf::from("/var/log"),
                packages_dir: PathBuf::from("/var/lib/pisi/package"),
                qt_dir: PathBuf::from("/usr"),
                tmp_dir: PathBuf::from("/var/pisi"),
            },
