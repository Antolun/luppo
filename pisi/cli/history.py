...
Lists previous operations.""")
    ...
    def options(self, group):
        ...
        group.title = _("history options")
        self.add_options(group)

    def add_options(self, group):
        group.add_argument("-l", "--last", action="store", type=int, default=0,
                         help=_("Output only the last n operations"))
        group.add_argument("-s", "--snapshot", action="store_true", default=False,
                         help=_("Take snapshot of the current system"))
        group.add_argument("-t", "--takeback", action="store", type=int, default=-1,
