...
""")
    ...
    def options(self, group):
        group.title = _("search options")
        group.add_argument("-l", "--language", action="store",
                               type=str, default=None, help=_('Summary and description language'))
        group.add_argument("-r", "--repository", action="store",
                               type=str, default=None, help=_('Name of the source or package repository'))
        group.add_argument("-i", "--installdb", action="store_true",
                               default=False, help=_("Search in installdb"))
        group.add_argument("-s", "--sourcedb", action="store_true",
        ...
        group.add_argument("--description", action="store_true",
