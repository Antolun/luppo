...
""")
    ...
    def options(self, group):
        ...
        group.title = _("list-installed options")

        group.add_argument("-b", "--with-build-host",
                         action="store",
                         default=None,
                         help=_("Only list the installed packages built "
                                "by the given host"))
        group.add_argument("-l", "--int", action="store_true",
                               default=False, help=_("Show in int format"))
        group.add_argument("-c", "--component", action="store",
                               default=None, help=_("List installed packages under given component"))
        group.add_argument("-i", "--install-info", action="store_true",
