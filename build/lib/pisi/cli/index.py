...
class Index(command.Command, metaclass=command.autocommand):
    ...
    def options(self, group):
        group.title = _("index options")

        group.add_argument("-a", "--absolute-urls",
                         action="store_true",
                         default=False,
        ...
        group.add_argument("--compression-types",
                         action="store",
                         default="xz",
                         help=_("Comma-separated compression types "
                                "for index file"))

        group.add_argument("--skip-sources",
                         action="store_true",
                         default=False,
                         help=_("Do not index PiSi spec files."))

        group.add_argument("--skip-signing",
                         action="store_true",
                         default=False,
