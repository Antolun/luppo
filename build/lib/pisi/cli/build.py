...
class Build(command.Command, metaclass=command.autocommand):
    ...
    def add_options(self, group):
        ...
        group.add_argument("--ignore-dependency",
                         action="store_true",
                         default=False,
    ...
    def add_steps_options(self):
        group = self.parser.add_argument_group(_("build steps"))
