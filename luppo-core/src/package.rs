...
pub struct Package {
    ...
    pub users: Option<luppo_spec::models::UsersWrapper>,

    #[serde(rename = "Groups", default)]
    pub groups: Option<luppo_spec::models::GroupsWrapper>,
...
mod tests {
    ...
    fn test_index_source_nesting() {
        ...
        <Package>
            ...
            <PackageURI>t/test-pkg.luppo</PackageURI>
        </Package>
        "#;
